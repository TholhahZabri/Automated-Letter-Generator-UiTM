...
$title = "Appreciation Letter Inbox";
include '../template/inbox_header.php';


?>

<h1>Appreciation Letter Inbox</h1><br>
...
include '../db_info.php';
		...
		try
		{
			...
			//sql query
			$stmt = $conn->prepare("SELECT * FROM letter_appreciation WHERE RECEIVER = '{$userid}' AND APPROVE_STAT = '1' ");
